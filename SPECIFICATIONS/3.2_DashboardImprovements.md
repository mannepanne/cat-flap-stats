...
## 🔄 Phase 3.2.1: Peak Hour Enhancement (Planned)

### Current Implementation Issue
The Peak Activity Hour widget currently uses only the most recent single day with activity data, which provides limited insight for trend analysis.

### Enhanced Peak Hour Calculation (To Be Implemented)

#### Improved Current Peak Hour
- **Method**: Combined view across all 21 days in the rolling window
- **Calculation**: Find the hour with highest total exit frequency across all 21 days combined
- **Benefit**: True peak hour representing recent behavioral patterns, not just one day

#### Enhanced Trend Detection  
- **First Half**: Days 1-10 combined peak hour calculation
- **Last Half**: Days 12-21 combined peak hour calculation  
...
#### Implementation Priority
1. **Phase 3.2.1a**: Implement enhanced 21-day combined peak hour calculation
2. **Phase 3.2.1b**: Add 10-day vs 10-day trend comparison  
3. **Phase 3.2.1c**: Update tooltip explanation with new methodology
4. **Future**: Implement historical meta-dataset when long-term analysis becomes priority

This enhancement will provide more meaningful behavioral insights by showing true recent patterns and robust trend detection rather than single-day snapshots.